...
using UnityEditor;
using UnityEngine;
using UniversalInjectorRuntime;

namespace UniversalInjectorEditor
{
    [CustomEditor(typeof(DataInjector))]
    public class DataInjectorEditor : Editor
    {
        #region Properties
        ...
        {
            _targetedScript = target as DataInjector;
        ...
        private void DrawTarget()
        {
            ...
            EditorGUILayout.LabelField("Target", _headerStyle);
        ...
        private void DrawSource()
        {
            ...
            EditorGUILayout.LabelField("Source", _headerStyle);
        ...
        private DataInjector _targetedScript;
